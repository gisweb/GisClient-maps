...
(function ($) {
  ...
  $(function () {
    ...
    var fieldPrefix = "formfield-form-widgets-";
    var fieldLat = "lat_progetto";
    var fieldLon = "lon_progetto";
    var fieldZoom = "zoom_progetto";
    ...
    var $element, $buttonElement, $txtAddress;
    ...
    $txtAddress = $("#gplaces");
    var gMapAutocomplete = new google.maps.places.Autocomplete($txtAddress.get(0));
  ...
  map.controls[google.maps.ControlPosition.TOP_LEFT].push(document.getElementById("gplaces"));
/*
...
*/
    ...
    function addDrawingManager(){
      ...
      var registerObject = function (element){
      ...
      function readDrawingShapes (){



      };

      function writeDrawingShapes (){



      };      
      function updateGeometryField (overlay,infoString){

        console.log(drawingShapes)
        for (var i=0;i<drawingShapes.length;i++){

          console.log(drawingShapes[i].getPath())
      ...
      var updateGeometryFieldss = function (overlay){
