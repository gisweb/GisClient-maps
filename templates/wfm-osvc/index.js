...
/*
        new OpenLayers.Contnew OpenLayers.Control.Button({iconclass:"glyphicon-white glyphicon-pencil", title:"Redline",
            trigger: function() {
                if (sidebarPanel.handleEvent)
                {rol.Button({iconclass:"glyphicon-white glyphicon-edit", type: OpenLayers.Control.TYPE_TOGGLE, title:"Editor vettoriale",

            eventListeners: {
                'activate': function(){vectorEditor.startEditMode();},
                'deactivatenew OpenLayers.Control.Button({iconclass:"glyphicon-white glyphicon-pencil", title:"Redline",
            trigger: function() {
                if (sidebarPanel.handleEvent)
                {': function(){vectorEditor.stopEditMode();}
            }
        }),
                ...
                if (sidebarPanel.handleEvent)
                {
                    ...
                    else
                    {
                        ...
                        if($.trim($('#printpanel').html()) == '') {
                            $("#printpanel").load(rootPath + 'panels/print_panel.html', function() {
